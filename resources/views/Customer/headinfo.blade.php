                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div style="margin-bottom: 0px;" class="form-group">
                                        <button style="margin-top: 24px;" type="button" onclick="btnhr()"  class="btn btn-block btn-warning">修改</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div style="height: 97px;" class="form-group">
                                        <button style="margin-top: 24px;" type="button" onclick="btnsms()" class="btn btn-block btn-warning">修改</button>
                                    </div>
                                </div>
