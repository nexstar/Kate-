            ...
            <div class="row" style="padding: 10px 50px 0px 50px;margin-bottom: 20px;">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>商品名稱</label>
                        <input value="{{ $TmpDB['title'] }}" id="title" name="title" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>商品價位</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <img id="imagesrc" src="{{ $TmpDB['src'] }}" style="width: 100%;height: 210px;margin-bottom: 1px;">
                        <input id="imagesrcupload" name="imagesrcupload" type="hidden" value="{{ $TmpDB['src'] }}">
                        <input id="imagesrcuploadFe" name="imagesrcuploadFe" type="hidden" value="{{ $TmpDB['fe'] }}">
                    </div>
                </div>
                ...
                <div class="col-md-6" style="margin-bottom: 20px;">
                    <div class="form-group">
                        ...
                        {!!
                            Form::select(
                                'pdbigitem', $tmpbigitem, $TmpDB['pdbigitem'],
                ...
                <div class="col-md-4" style="margin-bottom: 20px;">
                    <div class="form-group">
                        <label>紅利</label>
                        <input max="999" min="1" type="number" id="bouns" name="bouns" value="{{ $TmpDB['bouns'] }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4" style="margin-bottom: 20px;">
                    <div class="form-group">
                        <label>庫存</label>
                        <input max="999" min="1"  type="number" id="inventory" name="inventory" value="{{ $TmpDB['inventory'] }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-4" style="margin-bottom: 20px;">
                    <div class="form-group">
                        <label>預計上架日期</label>
                        <input id="date" name="date" type="text" value="{{ $TmpDB['date'] }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>內容</label>
                        <textarea id="contents" name="contents" rows="10" style="width:100%;resize:none;border-color: #dddddd;">{{ $TmpDB['contents'] }}</textarea>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            for($i=0;$i<_modelgc.length;$i++) {
                ...
                arraygc_fe.push(_modelgc[$i]['contents']);
            };
            gc_update();
            ...
            //小提示
            let _prompt = {!! json_encode($TmpDB['prompt']) !!};
            for($i=0;$i<_prompt.length;$i++){
                divsixmodelid.push(Date.now() + $i);
                divsixmodeltitle.push(_prompt[$i]);
                maxspan--;
            };
            update_divappend();
        });
