        ...
        <div class="container">
            ...
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-md-4" style="text-align: center;">
                    <p style="font-size: 30px;">綠寵物-Blog(新增)</p>
                </div>
            </div>

            {!! Form::open([ 'id' => 'creategreenpetblogfrom', 'method' => 'POST', 'action' => 'GreenPetBlogController@store', 'files' => true ]) !!}
                ...
                if(_title == ""){
                    ...
                    if(_imagesrc.length < 100){
                        ...
                        if(_contents == ""){
                            ...
                            if(confirm("確定綠新增寵物Blog??")){
                                $("#creategreenpetblogfrom").submit();
                            };
                        };
                    };
                };
