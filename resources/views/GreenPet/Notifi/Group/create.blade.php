        ...
        <div class="container">
            ...
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-md-4" style="text-align: center;">
                    <p style="font-size: 30px;">綠寵物-(群/新增)訊息推送</p>
                </div>
            </div>

            {!! Form::open([ 'id' => 'createnotifigroupfrom', 'method' => 'POST', 'action' => 'GreenPetNotifiGroupController@store', 'files' => true ]) !!}
            <div class="row">
                ...
                if(_title == ""){
                    ...
                    if(_src == "http://placehold.it/1170x613"){
                        ...
                        if( (CheckGroupcount == 0) ){
                            ...
                            if(confirm("確定新增[群體通知]")){
                                $("#createnotifigroupfrom").submit();
                            };
                        };
                    };
                };
