    ...
    <div id="main_right" class="col-md-12" style="margin-top: 55px;">
        <div class="container">
            ...
            <div class="row" style="padding-top: 20px;">
                <div class="col-md-2">
                    <a href="{{ url('greenpetnotifireservesingle') }}" class="btn btn-warning">返回</a>
                </div>
                <div class="col-md-8" style="text-align: center;">
                    <p style="font-size: 30px;">綠寵物-(單/修改/預約)訊息推送</p>
                </div>
                <div class="col-md-2"></div>
            </div>

            {!! Form::open([ 'id' => 'editnotifireservesinglefrom', 'method' => 'PUT', 'action' => ['GreenPetNotifiReserveSingleController@update',$TmpViewarray['id']] ]) !!}
            <div class="row">
            ...
            if( ( _contents.length > 90) || ( _contents.length <= 0)){
                ...
                if(_title == ""){
                    ...
                    if(_src == "http://placehold.it/1170x613"){
                        alert("綠寵物Blog封面照尚未上傳");
                    }else{
                        if( (radiosinglecount == 0) ){
                            alert('發送類型尚未選擇');
                        }else{
                            if(confirm("確定修改[預約/單項]通知")){
                                $("#editnotifireservesinglefrom").submit();
                            };
                        };
                    };
                };
