        ...
        <div class="container">
            ...
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-md-8" style="text-align: center;">
                    <p style="font-size: 30px;">綠寵物-(單/新增/預約)訊息推送</p>
                </div>
                <div class="col-md-2"></div>
            </div>

            {!! Form::open([ 'id' => 'createnotifireservesinglefrom', 'method' => 'POST', 'action' => 'GreenPetNotifiReserveSingleController@store', 'files' => true ]) !!}
            <div class="row">
                                ...
                                <div class="col-md-3" style="margin: 15px 0px 10px 0px;text-align: center;">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <input type="radio" name="radiosingle" value="{{ 'pettype_'.$result->_id }}">
                                        </div>
                        ...
                        <div style="border:1px solid #dddddd;height: 250px;overflow-y: scroll;">
                            @foreach($petsmallitems as $result)
                                <div class="col-md-4" style="margin: 15px 0px 10px 0px;text-align: center;">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <input type="radio" name="radiosingle" value="{{ 'petname_'.$result->_id }}">
                                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="border:1px solid #dddddd;height: 70px;overflow-y: scroll;">
                            ...
                            <div class="col-md-3" style="margin: 15px 0px 10px 0px;text-align: center;">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <input type="radio" name="radiosingle" value="gender_1">
                                    </div>
                        ...
                        <div style="border:1px solid #dddddd;height: 250px;overflow-y: scroll;">
                            @foreach($appwebusers as $appwebuserslist)
                                <div class="col-md-3" style="margin: 15px 0px 10px 0px;text-align: center;">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <input type="radio" name="radiosingle" value="{{ 'phone_'.$appwebuserslist->phone }}">
                                        </div>
                ...
                if(_title == ""){
                    ...
                    if(_src == "http://placehold.it/1170x613"){
                        ...
                        if( (radiosinglecount == 0) ){
                            ...
                            if(confirm("確定新增單項[預約]通知")){
                                $("#createnotifireservesinglefrom").submit();
                            };
                        };
                    };
                };
