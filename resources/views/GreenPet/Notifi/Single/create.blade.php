        ...
        <div class="container">
            ...
            <div class="row" style="padding-top: 20px;">
                ...
                <div class="col-md-4" style="text-align: center;">
                    <p style="font-size: 30px;">綠寵物-(單/新增)訊息推送</p>
                </div>
            </div>

            {!! Form::open([ 'id' => 'createnotifisinglefrom', 'method' => 'POST', 'action' => 'GreenPetNotifiSingleController@store', 'files' => true ]) !!}
            <div class="row">
                ...
                if(_title == ""){
                    ...
                    if(_src == "http://placehold.it/1170x613"){
                        ...
                        if( (radiosinglecount == 0) ){
                            ...
                            if(confirm("確定新增[單項通知]")){
                                $("#createnotifisinglefrom").submit();
                            };
                        };
                    };
                };
